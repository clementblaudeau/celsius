...
Lemma storeTyping_assgn:
  forall Σ σ l f v0 v C D ω μ μ0 μ__f,
    ...
    wf σ ->
    Σ ⊨ ([l ↦ (C, [f ↦ v]ω)]σ).
Proof with (meta; eauto with typ updates).
  intros.
  split; update_dom...
  intros l' H__l'.
  ...
  - rewrite getObj_update1...
    ...
    assert (f < dom Flds). { lets [?H ?H]: H6 H10. lets : H0 H__ct... }
    inverts H12.
    + eapply ot_hot... intros...
      lets [?v [ ]]: H18 f...
      lets [?v [ ]]: H18 f0...
      destruct_eq (f = f0); subst...
      * rewrite getVal_update1...
        exists v; split... eexists...
      * rewrite getVal_update2...
    + eapply ot_warm... intros.
      ...
      * rewrite getVal_update1...
        exists v; split... eexists...
      * rewrite getVal_update2...
    + lets: ot_cool Σ C ([f ↦ v] (ω)).
      rewrite update_one3 in H12.
      apply H12. clear H12.
      intros.
      lets: H15 μ__f H1 H2...
      destruct_eq (f = f0); subst...
      * rewrite getVal_update1 in H12... inverts H12...
        exists (T, μ)...
      * rewrite getVal_update2 in H12...
    + eapply ot_cold... intros.
      lets: H15 H1 H2...
      destruct_eq (f = f0); subst...
      * rewrite getVal_update1 in H12... inverts H12...
        exists (T, μ)...
