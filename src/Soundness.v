  ...
  - (* e = new C l *)
    ...
    + (* warm *)
      ...
      * eapply stk_st_trans with Σ1...
        ...
        -- lets [ ]: H__stk4 H__l; updates...
           inverts H10. inverts H11. left; exists x, T1; updates...
    ...
    + (* hot *)
      ...
      destruct (local_reasoning2 Σ1 Σ5 σ1 σ4 (codom args_val) {dom σ1} ) as
        (Σ6 & ? & ? & ? & ? & H__vnew)...
      * eapply wf_theorem_list...
      * lets H__scp5: scp_theorem_init Heq.
        lets [? _]: H__scp4 (codom args_val) σ1.

        eapply scp_union_intror, H12... eapply ss_trans with (σ1++[(C,[])]); updates...
      ...
      * exists Σ6, (dom σ1), σ4; splits...
        -- apply stk_st_trans with Σ1...
           ...
           ++ left. lets (?T & ?T & ? & ? & ?): H__mn5 l...
              exists C2, (C2, μ)...
              inverts H14... inverts H17...
           ++ updates.
              assert (l = dom σ1 \/ l < dom σ1) as [|] by lia...
              subst. left.
              exists C, (C, warm); updates...
        -- exists (C, hot)...
           lets: H__vnew (dom σ1) In_singleton... inverts H14. inverts H15. meta.
           assert (x = C); subst...
           lets (? & ? & ? & ? & ? & ?): (proj2 H13) (dom σ1)...
